...
class InputFeatures(object):
    ...
    def __init__(self, code, code_tokens, code_ids, position_idx, dfg_to_code, dfg_to_dfg, nl_tokens, nl_ids, url, ):
        self.code = code
...
def convert_examples_to_features(item):
    ...
    return InputFeatures(original_code, code_tokens, code_ids, position_idx,
                         dfg_to_code, dfg_to_dfg, nl_tokens, nl_ids, js['url'])
